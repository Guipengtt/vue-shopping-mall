  ...
  <div class="category" ref="aaa">
    ...
    <div class="right-div">
      <scroll class="right-scroll">
        <mait-key :maitItem="subCategoryDataList"></mait-key>
        <ul>
          <li>1</li>
          <li>2</li>
          <li>3</li>
...
import LeftControlBar from "@/views/category/childComps/LeftControlBar";
import MaitKey from "@/views/category/childComps/MaitKey";
  ...
  methods: {
    titleClick(index) {
      getSubcategory(this.categoryData[index].maitKey).then((res) => {
        this.subCategoryDataList = res.data.data.list;
        console.log(this.subCategoryDataList);
      });
    },
  },
};
